                            ...
                            @if(Auth::guard('admin')->user()->id != $data["id"])
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 @if ($errors->has('txtName')) has-error @endif">
                                        <input disabled type="text" id="txtName" name="txtName" required="required" class="form-control col-md-7 col-xs-12" value="{!! old('txtName', isset($data["name"]) ? $data["name"] : null) !!}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="txtPhone" class="control-label col-md-3 col-sm-3 col-xs-12">Số điện thoại</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input disabled id="txtPhone" class="form-control col-md-7 col-xs-12" type="text" name="txtPhone" value="{!! old('txtPhone', isset($data["phone"]) ? $data["phone"] : null) !!}">
                                    </div>
                                </div>
                            @endif
                            @if (Auth::guard('admin')->user()->id == $data["id"])
