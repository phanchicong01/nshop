...
class BaoKimPayment 
{
	...
	// Mã merchante site 
	private $merchant_id = '22160';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = 'm3cUnEFBEpKcmB99gSfQ'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	...
	public function createRequestUrl($order_id, $business, $total_amount, $shipping_fee, $tax_fee, $order_description, $url_success, $url_cancel, $url_detail)
	{
		...
		$params['checksum'] = strtoupper(($str_combined));
