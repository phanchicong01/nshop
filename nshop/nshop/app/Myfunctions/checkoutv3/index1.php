...
?>
	...
	<form  name="NLpayBank" action="<?=BASE_URL?>sanpham/test" method="post">	
		<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td>Số tiền thanh toán: </td>
				<td>
					 <input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="<?=$ttdh['tongtien'];?>">
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
